          ...
          <div className="flex-1 overflow-auto py-4">
            {isLoading ? (
              <div className="flex flex-col items-center justify-center py-20 gap-4">
                ...
                <p className="text-sm font-bold uppercase tracking-widest text-muted-foreground animate-pulse">Loading messages...</p>
              </div>
              ...
              <div className="flex flex-col items-center justify-center py-20 text-center bg-slate-50/50 rounded-2xl border border-dashed">
                ...
                <p className="text-sm text-muted-foreground max-w-[250px]">When users submit the contact form on your page, they will appear here.</p>
              </div>
            ) : (
              <div className="border rounded-xl overflow-hidden">
                <Table>
                  <TableHeader className="bg-muted/50">
                    <TableRow>
                      <TableHead className="font-bold text-[10px] uppercase tracking-widest">Sender</TableHead>
                      <TableHead className="font-bold text-[10px] uppercase tracking-widest">Message</TableHead>
                      <TableHead className="font-bold text-[10px] uppercase tracking-widest text-right">Date</TableHead>
                    </TableRow>
                  </TableHeader>
                  <TableBody>
                    {submissions.map((s) => (
                        ...
                        <TableCell className="align-top py-4">
                          <div className="flex flex-col gap-1">
                            <span className="font-bold text-sm flex items-center gap-2">
                              <User className="w-3 h-3 text-muted-foreground" /> {s.name}
                            </span>
