    ...
    <div className="min-h-screen flex items-center justify-center bg-background text-foreground">
      <div className="text-center px-6 py-12 max-w-2xl">
        ...
        <p className="text-xl text-muted-foreground mb-10 leading-relaxed">
          The ultimate playground for generating high-vibe themes and
          mini-sites. Stop focusing on code, start focusing on the{' '}
          <span className="italic font-semibold">vibe</span>.
        </p>
        <Button
          asChild
          size="lg"
